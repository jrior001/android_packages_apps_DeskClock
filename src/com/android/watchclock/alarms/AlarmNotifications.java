...
import com.android.watchclock.NotificationChannelManager;
import com.android.watchclock.NotificationChannelManager.Channel;
...
final class AlarmNotifications {
     ...
     * {@link com.android.watchclock.data.NotificationModel}
     */
    ...
    static Intent createViewAlarmIntent(Context context, AlarmInstance instance) {
        ...
        return Alarm.createIntent(context, WatchClock.class, alarmId)
