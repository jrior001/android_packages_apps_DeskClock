...
package com.android.watchclock.alarms;
...
import com.android.watchclock.AlarmClockFragment;
import com.android.watchclock.LabelDialogFragment;
...
import com.android.watchclock.ringtone.RingtonePickerActivity;
...
public final class AlarmTimeClickHandler {
    ...
    public void setAlarmVibrationEnabled(Alarm alarm, boolean newState) {
        if (newState != alarm.vibrate) {
            ...
            Events.sendAlarmEvent(R.string.action_toggle_vibrate, R.string.label_watchclock);
    ...
    public void setAlarmRepeatEnabled(Alarm alarm, boolean isEnabled) {
        ...
        Events.sendAlarmEvent(R.string.action_toggle_repeat_days, R.string.label_watchclock);
    ...
    public void onDeleteClicked(AlarmItemHolder itemHolder) {
        ...
        Events.sendAlarmEvent(R.string.action_delete, R.string.label_watchclock);
    ...
    public void onClockClicked(Alarm alarm) {
        ...
        Events.sendAlarmEvent(R.string.action_set_time, R.string.label_watchclock);
    ...
    public void onRingtoneClicked(Context context, Alarm alarm) {
        mSelectedAlarm = alarm;
        Events.sendAlarmEvent(R.string.action_set_ringtone, R.string.label_watchclock);
    ...
    public void onEditLabelClicked(Alarm alarm) {
        Events.sendAlarmEvent(R.string.action_set_label, R.string.label_watchclock);
