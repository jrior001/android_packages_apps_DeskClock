...
import com.android.watchclock.AlarmAlertWakeLock;
import com.android.watchclock.AlarmClockFragment;
import com.android.watchclock.AlarmUtils;
import com.android.watchclock.AsyncHandler;
...
public final class AlarmStateManager extends BroadcastReceiver {
    ...
    public static final String ACTION_ALARM_CHANGED = "com.android.watchclock.ALARM_CHANGED";
    ...
    private void handleIntent(Context context, Intent intent) {
        ...
        if (CHANGE_STATE_ACTION.equals(action)) {
            ...
            final Intent viewAlarmIntent = Alarm.createIntent(context, WatchClock.class, alarmId)
