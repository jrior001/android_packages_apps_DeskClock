...
package com.android.watchclock.alarms.dataadapter;
    ...
    private ExpandedAlarmViewHolder(View itemView, boolean hasVibrator) {
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Events.sendAlarmEvent(R.string.action_collapse_implied, R.string.label_watchclock);
        ...
        arrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Events.sendAlarmEvent(R.string.action_collapse, R.string.label_watchclock);
                getItemHolder().collapse();
            }
        });
        // Edit time handler
