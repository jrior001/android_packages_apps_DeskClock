...
package com.android.watchclock.timer;
...
import com.android.watchclock.AnimatorUtils;
import com.android.watchclock.WatchClock;
import com.android.watchclock.WatchClockFragment;
...
import com.android.watchclock.data.TimerListener;
import com.android.watchclock.data.TimerStringFormatter;
 ...
 */
public final class TimerFragment extends WatchClockFragment {

    private static final String EXTRA_TIMER_SETUP = "com.android.watchclock.action.TIMER_SETUP";
    ...
    public static Intent createTimerSetupIntent(Context context) {
        return new Intent(context, WatchClock.class).putExtra(EXTRA_TIMER_SETUP, true);
    }
        ...
        if (mCurrentView == mTimersView) {
            ...
            switch (timer.getState()) {
                case RUNNING:
                    ...
                    Events.sendTimerEvent(R.string.action_stop, R.string.label_watchclock);
                    if (currentTime > 0) {
                ...
                case RESET:
                    ...
                    Events.sendTimerEvent(R.string.action_start, R.string.label_watchclock);
                    if (currentTime > 0) {
                        mTimersView.announceForAccessibility(TimerStringFormatter.formatString(
                ...
                case MISSED:
                case EXPIRED:
                    DataModel.getDataModel().resetOrDeleteTimer(timer, R.string.label_watchclock);
                    break;
            }
            ...
            try {
                ...
                Events.sendTimerEvent(R.string.action_create, R.string.label_watchclock);
    ...
    private void animateTimerRemove(final Timer timerToRemove) {
        ...
        fadeOut.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                Events.sendTimerEvent(R.string.action_delete, R.string.label_watchclock);
            }
        });
