...
public final class TimerService extends Service {
    ...
    private static final String ACTION_PREFIX = "com.android.watchclock.action.";
    ...
    public static final String EXTRA_TIMER_ID = "com.android.watchclock.extra.TIMER_ID";
        ...
        try {
            ...
            switch (action) {
                case ACTION_SHOW_TIMER: {
                    ...
                    // Open WatchClock which is now positioned on the timers tab and show the timer
                    // in question.
                    final Intent showTimers = new Intent(this, WatchClock.class)
                            .putExtra(EXTRA_TIMER_ID, timerId)
