...
import com.android.watchclock.data.CityListener;
...
import static com.android.watchclock.uidata.UiDataModel.Tab.CLOCKS;
import static java.util.Calendar.DAY_OF_WEEK;

/**
 * Fragment that shows the clock (analog or digital), the next alarm info and the world clock.
 */
public final class ClockFragment extends WatchClockFragment {
    ...
    private final class StartScreenSaverListener implements View.OnLongClickListener {
        ...
        public boolean onLongClick(View view) {
            startActivity(new Intent(getActivity(), ScreensaverActivity.class)
                    ...
                    .putExtra(Events.EXTRA_EVENT_LABEL, R.string.label_watchclock));
            return true;
        }
    }
