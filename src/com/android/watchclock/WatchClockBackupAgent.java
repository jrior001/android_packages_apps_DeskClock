...
public class WatchClockBackupAgent extends BackupAgent {

    private static final LogUtils.Logger LOGGER = new LogUtils.Logger("WatchClockBackupAgent");

    public static final String ACTION_COMPLETE_RESTORE =
            "com.android.watchclock.action.COMPLETE_RESTORE";
     ...
     * Instead, a future callback to WatchClock is used as a signal to reschedule the alarms. The
    ...
    public void onRestoreFinished() {
        ...
        // Create an Intent to send into WatchClock indicating restore is complete.
    ...
    public static boolean processRestoredData(Context context) {
        ...
        for (Alarm alarm : alarms) {
            ...
            if (alarm.enabled) {
                ...
                LOGGER.i("WatchClockBackupAgent scheduled alarm instance: %s", alarmInstance);
            }
        }
