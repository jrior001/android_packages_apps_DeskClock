...
/**
 * This adapter produces the WatchClockFragments that are the content of the WatchClock tabs. The
...
final class FragmentTabPagerAdapter extends PagerAdapter {
    ...
    private final WatchClock mWatchClock;
    ...
    private final Map<UiDataModel.Tab, WatchClockFragment> mFragmentCache;
    ...
    FragmentTabPagerAdapter(WatchClock watchClock) {
        mWatchClock = watchClock;
        mFragmentCache = new ArrayMap<>(getCount());
        mFragmentManager = watchClock.getFragmentManager();
    }
     ...
     */
    WatchClockFragment getWatchClockFragment(int position) {
        ...
        WatchClockFragment fragment = mFragmentCache.get(tab);
        if (fragment != null) {
            return fragment;
        }
        ...
        fragment = (WatchClockFragment) mFragmentManager.findFragmentByTag(tab.name());
        if (fragment != null) {
            fragment.setFabContainer(mWatchClock);
        ...
        fragment = (WatchClockFragment) Fragment.instantiate(mWatchClock, fragmentClassName);
        fragment.setFabContainer(mWatchClock);
        mFragmentCache.put(tab, fragment);
        return fragment;
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (fragment != null) {
            ...
            fragment = getWatchClockFragment(position);
    ...
    public void destroyItem(ViewGroup container, int position, Object object) {
        ...
        final WatchClockFragment fragment = (WatchClockFragment) object;
