...
package com.android.watchclock.stopwatch;
...
import com.android.watchclock.StopwatchTextController;
import com.android.watchclock.ThemeUtils;
import com.android.watchclock.Utils;
import com.android.watchclock.data.DataModel;
import com.android.watchclock.data.Lap;
import com.android.watchclock.data.Stopwatch;
import com.android.watchclock.data.StopwatchListener;
...
import com.android.watchclock.uidata.UiDataModel.Tab;
...
import static com.android.watchclock.uidata.UiDataModel.Tab.STOPWATCH;

/**
 * Fragment that shows the stopwatch and recorded laps.
 */
public final class StopwatchFragment extends WatchClockFragment {
    ...
    private void doStart() {
        Events.sendStopwatchEvent(R.string.action_start, R.string.label_watchclock);
        DataModel.getDataModel().startStopwatch();
    }
    ...
    private void doPause() {
        Events.sendStopwatchEvent(R.string.action_pause, R.string.label_watchclock);
        DataModel.getDataModel().pauseStopwatch();
    }
    ...
    private void doReset() {
        ...
        Events.sendStopwatchEvent(R.string.action_reset, R.string.label_watchclock);
    ...
    private void doAddLap() {
        Events.sendStopwatchEvent(R.string.action_lap, R.string.label_watchclock);
